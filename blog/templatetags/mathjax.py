...
def mathjax_scripts():
    ...
    if mathjax_local_path:
        ...
        mathjax_js_url = '//cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js'  # update mathjax.js

    mathjax_config_file = getattr(settings, 'MATHJAX_CONFIG_FILE', "TeX-MML-AM_CHTML")# update config
