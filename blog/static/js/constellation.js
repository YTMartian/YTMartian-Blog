...
function addEmittersAndFields(e) {
    var t = e.display;
    t.logo.width = $("#dot_line_blachole").width(),
        t.logo.height = $("#dot_line_blachole").height(),
        t.logo.position = $("#dot_line_blachole").position(),
...
var Stats = function () {
    ...
    m.id = "ms",
        m.style.cssText = "padding:0 0 3px 3px;text-align:left;background-color:#020;dot_line_display:none",
        u.appendChild(m);
            ...
            var D = "iframe",
                ...
                R = function (e) {
                    if (t.currTemplate[D]) {
                        ...
                        n.length && (e || (n[0].src = U), t.isIE8 && n.css("dot_line_display", e ? "block" : "none"))
                    }
                };
